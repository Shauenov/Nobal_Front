...
/** Fetch from pre-signed URL and trigger browser download */
async function handleDownload(doc: DocumentOut) {
  try {
    ...
    const ext = doc.content_type === 'application/pdf' ? '.pdf'
              : doc.content_type.startsWith('image/') ? `.${doc.content_type.split('/')[1]}`
              : '';
    a.href = blobUrl;
                  ...
                  <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: '#475569', fontSize: '0.78rem', cursor: 'pointer', fontWeight: 600,
                      }}
                    >
                      ↓ Скачать
                    </button>
